<template>
  <footer class="py-10 px-4 border-t border-gray-200 bg-white">
    <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
      <div class="flex items-center gap-2">
        <div class="w-6 h-6 rounded bg-gradient-to-br from-purple-primary to-blue-primary flex items-center justify-center">
          <span class="text-white font-bold text-xs">V</span>
        </div>
        <span class="text-sm font-medium gradient-text">VideoGrab</span>
      </div>
